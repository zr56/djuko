...
import v.v_play_jawa;
import m.m_djuko;
import v.v_popUp_beli;

public class c_play_jawa {
    ...
    public c_play_jawa(String username) throws SQLException {
        this.theV = new v_play_jawa();
        this.theM = new m_djuko();
        this.theVB = new v_popUp_beli();
        this.username = username;
        this.theV.setVisible(true);

        ikan = theV.setJumlahIkan(theM.getJumlahIkanJawa(username));
        ...
        jumlah_ikan = theM.getJumlahIkanJawa(username);
    ...
    private class backAction implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                Logger.getLogger(c_play_jawa.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
