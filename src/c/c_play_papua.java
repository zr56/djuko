...
import v.v_play_papua;
import m.m_djuko;
import v.v_popUp_beli;

public class c_play_papua {
    ...
    public c_play_papua(String username) throws SQLException {
        this.theV = new v_play_papua();
        this.theM = new m_djuko();
        this.theVB = new v_popUp_beli();
        this.username = username;
        this.theV.setVisible(true);

        ikan = theV.setJumlahIkan(theM.getJumlahIkanPapua(username));
        ...
        jumlah_ikan = theM.getJumlahIkanPapua(username);
    ...
    private class backAction implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                Logger.getLogger(c_play_papua.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
