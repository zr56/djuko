...
import v.v_play_sulawesi;
import m.m_djuko;
import v.v_popUp_beli;

public class c_play_sulawesi {

    v_play_sulawesi theV;
    v_popUp_beli theVB;
    ...
    public c_play_sulawesi(String username) throws SQLException {
        this.theV = new v_play_sulawesi();
        this.theM = new m_djuko();
        this.theVB = new v_popUp_beli();
        this.username = username;
        this.theV.setVisible(true);

        //        theV.setIkan(theM.getJumlahIkan(username));
        ikan = theV.setJumlahIkan(theM.getJumlahIkanSulawesi(username));
        ...
        jumlah_ikan = theM.getJumlahIkanSulawesi(username);
