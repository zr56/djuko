...
public class v_play_kalimantan extends javax.swing.JFrame {
    ...
    public void tambahIkan(int x, int y, int value, int value_2, ActionListener e, String id[]) {
        ...
        tombol.setIcon(new ImageIcon(getClass().getResource("/img/fish_kalimantan.gif")));
    ...
    private void initComponents() {
        ...
        daerah.setText("Level Kalimantan");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v_play_kalimantan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new v_play_kalimantan().setVisible(true);
            }
        });
    }
