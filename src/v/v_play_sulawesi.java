...
public class v_play_sulawesi extends javax.swing.JFrame {
    ...
    public void tambahIkan(int x, int y, int value, int value_2, ActionListener e, String id[]) {
        ...
        tombol.setIcon(new ImageIcon(getClass().getResource("/img/fish_sulawesi.gif")));
    ...
    private void initComponents() {
        ...
        getContentPane().add(jumlah_ikan, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 30, 30, 30));
        ...
        getContentPane().add(btn_beri_makan, new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 92, 52, 28));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v_play_sulawesi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new v_play_sulawesi().setVisible(true);
            }
        });
    }
