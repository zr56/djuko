...
public class v_play_sumatera extends javax.swing.JFrame {

    int tambah;
    public JProgressBar umur = new JProgressBar(0, 10);
    public JProgressBar hp = new JProgressBar(0, 100);
    public ArrayList<JButton> btn = new ArrayList<JButton>();

    public v_play_sumatera() {
        initComponents();
    ...
    public void tambahIkan(int x, int y, int value, int value_2, ActionListener e, String id[]) {
        ...
        hLabel.setBounds(x + 70, y - 20, 40, 10);
        panel.add(hLabel);
        //ikan
        panel.setLayout(null);
        JButton tombol = new JButton();
        tombol.setIcon(new ImageIcon(getClass().getResource("/img/fish_sumatera.gif")));
    ...
    public void getStatusIkan(int tambah) {
        hp.setValue(tambah);
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jumlah_makanan, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 32, 30, 30));

        jumlah_obat.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        getContentPane().add(jumlah_obat, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 32, 30, 30));

        jumlah_ikan.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        getContentPane().add(jumlah_ikan, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 32, 30, 30));
        ...
        getContentPane().add(txt_beri_makan, new org.netbeans.lib.awtextra.AbsoluteConstraints(79, 100, 20, 15));
        ...
        getContentPane().add(btn_home, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 0, 30, 30));

        daerah.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        daerah.setForeground(new java.awt.Color(255, 255, 255));
        daerah.setText("Level Sumatera");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v_play_sumatera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new v_play_sumatera().setVisible(true);
            }
        });
    }
